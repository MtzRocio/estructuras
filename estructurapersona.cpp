...
cin>>p1[i].estatura;
cout<<"Calle: ";
// fflush(stdin);//se utiliza en caso de que el espacio del bufer se 
llene, para no repetir el comando siguiente
cin.getline(p1[i].dire.calle,20,'\n');//se repiten porque cuando se 
llenan los bufers se tienen que liberar, para que permita pedir mas 
datos
cin.getline(p1[i].dire.calle,20,'\n');
}
//mostrar guardado
